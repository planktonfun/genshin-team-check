...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x2013d40 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x2013d40(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(62583676);
}
