...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x2352f68 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x2352f68(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(60368420);
}
