...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x2ba5aa0 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const BannerMap = [
	'Abyss',
	'Alteo_Empire',
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback60531516 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback60531516(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x2ba5aa0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
