...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0xc33088 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0xc33088(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);

}


};gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x1e71858 = function(runtimeScene, eventsFunctionContext) {
"use strict";
const enableDeflation = runtimeScene.getGame().getVariables().get('DeflateMessages').getAsBoolean(); // deflation costs about 5 fps to lower end settings
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x1e71858(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
