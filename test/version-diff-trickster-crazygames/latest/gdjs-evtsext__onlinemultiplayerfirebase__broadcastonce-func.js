...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x4b95930 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x4b95930(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);

}


};gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x26c8b98 = function(runtimeScene, eventsFunctionContext) {
"use strict";
const enableDeflation = runtimeScene.getGame().getVariables().get('DeflateMessages').getAsBoolean(); // deflation costs about 5 fps to lower end settings
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x26c8b98(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
