...
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x371f188 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
    lobby.setUserCards(
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x371f188(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
