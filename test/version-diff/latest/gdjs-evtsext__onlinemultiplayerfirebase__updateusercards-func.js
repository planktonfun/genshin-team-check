...
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x132b718 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
    lobby.setUserCards(
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x132b718(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
