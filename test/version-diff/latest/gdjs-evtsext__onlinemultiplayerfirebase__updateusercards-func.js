...
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0xc14820 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
    lobby.setUserCards(
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0xc14820(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
