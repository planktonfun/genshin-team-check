...
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x2daa7e0 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
    lobby.setUserCards(
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__UpdateUserCards.userFunc0x2daa7e0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
