...
if (typeof gdjs.evtsExt__Observers__ObserveSceneVarByObject !== "undefined") {
  gdjs.evtsExt__Observers__ObserveSceneVarByObject.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__Observers__ObserveSceneVarByObject = {};
gdjs.evtsExt__Observers__ObserveSceneVarByObject.GDObserverObjectObjects1= [];


gdjs.evtsExt__Observers__ObserveSceneVarByObject.userFunc0x2ab4b08 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
observers.forEach(observer=>{
    subject.addObserver(observer._observer);
});
...
gdjs.evtsExt__Observers__ObserveSceneVarByObject.eventsList0 = function(runtimeScene, eventsFunctionContext) {

{


gdjs.evtsExt__Observers__ObserveSceneVarByObject.userFunc0x2ab4b08(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__Observers__ObserveSceneVarByObject.func = function(runtimeScene, ObserverObject, Observer, SceneVariable, parentEventsFunctionContext) {
...
gdjs.evtsExt__Observers__ObserveSceneVarByObject.GDObserverObjectObjects1.length = 0;

gdjs.evtsExt__Observers__ObserveSceneVarByObject.eventsList0(runtimeScene, eventsFunctionContext);

return;
}

gdjs.evtsExt__Observers__ObserveSceneVarByObject.registeredGdjsCallbacks = [];