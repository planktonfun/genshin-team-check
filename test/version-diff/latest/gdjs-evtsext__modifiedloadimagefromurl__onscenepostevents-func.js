...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0xe672e0 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0xe672e0(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(70458596);
}
