...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0xe80eb8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0xe80eb8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(71740500);
}
