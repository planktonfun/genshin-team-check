...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x25a6078 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ModifiedLoadImageFromURL__onScenePostEvents.userFunc0x25a6078(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(69837964);
}
