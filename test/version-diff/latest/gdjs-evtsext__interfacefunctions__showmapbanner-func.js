...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x39f31f0 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const BannerMap = [
	'Abyss',
	'Alteo_Empire',
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback77501996 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback77501996(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x39f31f0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
