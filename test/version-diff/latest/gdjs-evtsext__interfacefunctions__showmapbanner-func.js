...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x1171f50 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const BannerMap = [
	'Abyss',
	'Alteo_Empire',
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback72338180 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.asyncCallback72338180(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
gdjs.evtsExt__InterfaceFunctions__ShowMapBanner.userFunc0x1171f50(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
