...
gdjs.evtsExt__OnlineMultiplayerFirebase__RestoreUserCard.userFunc0x36ae010 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__RestoreUserCard.userFunc0x36ae010(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
