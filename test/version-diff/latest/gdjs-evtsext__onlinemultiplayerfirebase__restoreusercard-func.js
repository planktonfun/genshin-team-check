...
gdjs.evtsExt__OnlineMultiplayerFirebase__RestoreUserCard.userFunc0x3586728 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__RestoreUserCard.userFunc0x3586728(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
