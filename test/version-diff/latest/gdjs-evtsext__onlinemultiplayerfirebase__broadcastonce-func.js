...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x483fac8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x483fac8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);

}


};gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x2df80d8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
const enableDeflation = runtimeScene.getGame().getVariables().get('DeflateMessages').getAsBoolean(); // deflation costs about 5 fps to lower end settings
...
gdjs.evtsExt__OnlineMultiplayerFirebase__BroadCastOnce.userFunc0x2df80d8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
