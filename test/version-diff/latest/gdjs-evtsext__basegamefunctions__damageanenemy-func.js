...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("MonsterDictionary").getChild((gdjs.RuntimeObject.getVariableString(((gdjs.evtsExt__BaseGameFunctions__DamageAnEnemy.GDMobsObjects5.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.evtsExt__BaseGameFunctions__DamageAnEnemy.GDMobsObjects5[0].getVariables()).get("MonsterName")))).getChild("sounds").getChild("hurt")) != "0");
}
if (isConditionTrue_0) {
...
}{gdjs.evtTools.network.jsonToVariableStructure(gdjs.evtTools.network.variableStructureToJSON(runtimeScene.getScene().getVariables().get("MonsterDictionary").getChild((gdjs.RuntimeObject.getVariableString(((gdjs.evtsExt__BaseGameFunctions__DamageAnEnemy.GDMobsObjects1.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.evtsExt__BaseGameFunctions__DamageAnEnemy.GDMobsObjects1[0].getVariables()).get("MonsterName")))).getChild("baseStats")), runtimeScene.getScene().getVariables().get("RecievingBaseStats"));
