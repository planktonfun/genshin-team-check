...
}{gdjs.evtTools.network.jsonToVariableStructure(gdjs.evtTools.network.variableStructureToJSON(runtimeScene.getScene().getVariables().get("MonsterDictionary").getChild((( gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects2.length === 0 ) ? "" :gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects2[0].getName())).getChild("baseStats")), runtimeScene.getScene().getVariables().get("BaseStats"));
}{runtimeScene.getScene().getVariables().get("BaseStats").getChild("level").setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("MonsterDictionary").getChild((( gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects2.length === 0 ) ? "" :gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects2[0].getName())).getChild("level")));
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.variableChildExists(runtimeScene.getScene().getVariables().get("MonsterDictionary"), (( gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects1.length === 0 ) ? "" :gdjs.evtsExt__BaseGameFunctions__DamageAPlayerUsingSkill.GDMobsObjects1[0].getName()));
if (isConditionTrue_0) {
