...
gdjs.evtsExt__OnlineMultiplayerFirebase__DeleteUserCard.userFunc0x358abd0 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if(window['lobby']) {
...
var objects = [];
gdjs.evtsExt__OnlineMultiplayerFirebase__DeleteUserCard.userFunc0x358abd0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
