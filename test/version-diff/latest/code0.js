...
gdjs.LoginCode.userFunc0x15a29b8 = function(runtimeScene) {
"use strict";
...
gdjs.LoginCode.userFunc0x15a29b8(runtimeScene);

}


};gdjs.LoginCode.userFunc0xd0f388 = function(runtimeScene) {
"use strict";
...
};gdjs.LoginCode.asyncCallback80378244 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.LoginCode.asyncCallback80378244(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoginCode.userFunc0xd1a990 = function(runtimeScene) {
"use strict";
var a = {
        "GlobalVariables": {
            "Raw": {
...
gdjs.LoginCode.userFunc0x337bc08 = function(runtimeScene) {
"use strict";
...
gdjs.LoginCode.userFunc0x337bc08(runtimeScene);
...
gdjs.LoginCode.userFunc0xd0f388(runtimeScene);
...
gdjs.LoginCode.userFunc0xd1a990(runtimeScene);
...
gdjs.LoginCode.asyncCallback80390436 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.LoginCode.asyncCallback80390436(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.LoginCode.asyncCallback80407508 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "CharacterCreation", false);
}}
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.LoginCode.asyncCallback80407508(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoginCode.asyncCallback80409532 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "CharacterCreation", false);
}}
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.LoginCode.asyncCallback80409532(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.LoginCode.asyncCallback80414236 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.LoginCode.asyncCallback80414236(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_2) {
isConditionTrue_2 = false;
{isConditionTrue_2 = runtimeScene.getOnceTriggers().triggerOnce(80406836);
}
}
}
isConditionTrue_1 = isConditionTrue_2;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(84230004);
}
}
if (isConditionTrue_0) {
{gdjs.evtsExt__InterfaceFunctions__ClearTransparentTextMessage.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(83817620);
}
}
if (isConditionTrue_0) {
